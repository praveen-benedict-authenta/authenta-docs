...
// Example usage
try {
  const result = await processDetectionTask('./shared/video.mp4', 'result + heatmaps');
...
/input
/images - fake.jpg - real.jpg
/videos - fake.mp4 - real.mp4
...
2. **File Access**
   ...
   # Check permissions
   sudo chown -R your-user:docker ./shared
   ```
