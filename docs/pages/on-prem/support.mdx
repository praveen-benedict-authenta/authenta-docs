...
| **Integration**              | Help integrating your application with the Authenta API Server              |
...
1. **Environment Information**
   ...
   - GPU model/driver version (`ml-task-runner-gpu` requires NVIDIA GPU acceleration)
...
| Documentation Portal | [docs.authenta.ai](docs.authenta.ai) | Full setup and configuration guides               |
